...
/* =====================================================
   OPTIMIZED STAT CARD - PERFORMANCE FOCUSED
   ===================================================== */
const ExtraordinaryStatCard = ({ number, label, gradient, delay, index }) => {
    return (
        ...
        >
            <div
                className="relative h-full overflow-hidden rounded-3xl bg-slate-900/50 backdrop-blur-2xl shadow-2xl transition-all duration-300"
                style={{
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center p-6 md:p-8 h-full min-h-[180px] md:min-h-[220px]">
                    ...
                    {/* Bottom accent line */}
                    <div
                        className="absolute bottom-0 left-1/4 right-1/4 h-1 rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-300"
                        style={{
